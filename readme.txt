...
**Important: This plugin is no longer being supported or updated because AWeber now have an [official WordPress plugin](http://wordpress.org/plugins/aweber-web-form-widget/).**

**We recommend uninstalling the AWeber Integration plugin and following [AWeber's official instructions on integrating WordPress with AWeber](https://help.aweber.com/entries/21712372-How-Do-I-Integrate-My-Wordpress-Blog-With-AWeber-).**
...
= 2.3.1 =
* Fix deprecated function warning when WP_DEBUG is turned on.
...
= 2.3.1 =
* Fixes deprecated function warning.

= 2.3 =
* WordPress 3.5 compatibility, deprecated function removal.
